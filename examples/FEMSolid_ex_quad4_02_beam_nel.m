%FEMSOLID_EX_QUAD4_02_BEAM_NEL Runs an FEM-Solid Edu example.
% ------------------------------------------------------------------------
% DESCRIPTION
...
setup.material.name = 'StVenant';         % nichtlinear: 'StVenant', 'NeoHookean1', 'NeoHookean2'

% ------------------------------------------------------------------------
% Lastschritte und Newton-Verfahren
setup.analysis.numSteps = 3;
...
% ------------------------------------------------------------------------
% FE-Modell erzeugen
model = data_ex_quad4_02_beam_nel(numELx, numELy, setup);
